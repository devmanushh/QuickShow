...
const HeroSection = () => {
  ...
  return (
    ...
    bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen'>
        ...
        <h1 className='text-5xl md:text-[70px] md:leading-18 font-semibold max-w-120 text-white'>
        ...
        <p className='max-w-md text-gray-300'> A band of misfits turned heroes, the Guardians of the Galaxy protect the universe with courage, humor, and heart.</p>
