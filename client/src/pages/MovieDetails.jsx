            ...
            <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
                <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="relative flex flex-col gap-3">
                        ...
                        join(", ")}. {show.movie.release_date.split("-")[0]} </p>
                        ...
                        {showTrailer && show.movie.trailer && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80">
                                <div className="relative w-full max-w-2xl aspect-video bg-black rounded-lg shadow-lg flex items-center justify-center">
                                    <button onClick={() => setShowTrailer(false)} className="absolute top-2 right-2 text-white text-2xl font-bold z-10">&times;</button>
                                    <iframe
                                        width="100%"
                                        height="100%"
                                        src={`https://www.youtube.com/embed/${show.movie.trailer}`}
